    ...
    int myAtoi(string str) {
        ...
        while(str[index]>='0'&&str[index]<='9'){
            if(ans > INT_MAX/10 ||(ans == INT_MAX/10 && str[index]-'0'>7)){
                return label>0 ? INT_MAX:INT_MIN;
            }
...
Your runtime beats 55.78 % of cpp submissions
Your memory usage beats 13.21 % of cpp submissions (8.6 MB)*/
